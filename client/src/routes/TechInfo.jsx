...
let flag = false; // flag=false allows useEffect to fire fetchData func, where it is set to true in order to stop useEffect from running fetchData multiple times because server is still processing previous request
